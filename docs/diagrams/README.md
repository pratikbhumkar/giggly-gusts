...
| File | Topic |
|------|--------|
| [01-system-context.md](./01-system-context.md) | Viewer → edge → **ECR** + Lambda (container) → Open-Meteo / fallback |
...
| [04-ci-cd-stages.md](./04-ci-cd-stages.md) | Build → test → **docker build** → optional **ECR push** → Terraform → optional deploy |
